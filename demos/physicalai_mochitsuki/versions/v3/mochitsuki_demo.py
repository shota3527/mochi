...
SCENE_TEMPLATE_PATH = PROJECT_ROOT / "demos" / "mochitsuki" / "scene_mochitsuki_v3.xml"
...
MIN_HANDLE_LATERAL_ALIGNMENT = 0.90
...
GRIP_SPECS = (
    GripSpec(
        ...
        np.array([0.6018, 0.6847, 0.4112], dtype=np.float64),
        np.array([0.7384, -0.6731, 0.0401], dtype=np.float64),
    ),
    GripSpec(
        ...
        np.array([-1.0, 0.0, 0.0], dtype=np.float64),
        np.array([0.1120, 0.0320, -0.0100], dtype=np.float64),
        np.array([0.3840, 0.8947, 0.2282], dtype=np.float64),
        np.array([0.9045, -0.4142, 0.1016], dtype=np.float64),
    ),
)
...
BASE_XY = np.array([0.2582, -0.1255], dtype=np.float64)
BASE_YAW = 0.70
...
REFERENCE_HANDLE_WORLD = ROBOT_LEFT_WORLD + 0.08 * ROBOT_FORWARD_WORLD
REFERENCE_HANDLE_WORLD = REFERENCE_HANDLE_WORLD / np.linalg.norm(REFERENCE_HANDLE_WORLD)
PELVIS_Z = 0.735

def reference_video_quat(head_forward_tilt: float, head_left_tilt: float = 0.0) -> np.ndarray:
    z_axis_hint = (
        np.array([0.0, 0.0, 1.0], dtype=np.float64)
        - ROBOT_FORWARD_WORLD * head_forward_tilt
        + ROBOT_LEFT_WORLD * head_left_tilt
    )
    return quat_from_yz(REFERENCE_HANDLE_WORLD, z_axis_hint)


IMPACT_QUAT = reference_video_quat(0.00)
COMPRESS_QUAT = reference_video_quat(0.03)
RELEASE_QUAT = reference_video_quat(0.22, 0.02)
LIFT_LOW_QUAT = reference_video_quat(0.45, 0.04)
LIFT_MID_QUAT = reference_video_quat(0.70, 0.06)
LIFT_TOP_QUAT = reference_video_quat(0.82, 0.06)
AIM_HIGH_QUAT = reference_video_quat(0.55, 0.04)
AIM_LOW_QUAT = reference_video_quat(0.26, 0.02)
STRIKE_PRE_QUAT = reference_video_quat(0.10, 0.01)
STRIKE_QUAT = IMPACT_QUAT

HAMMER_TARGET_WORLD = np.array([0.78, 0.00, 0.0], dtype=np.float64)
...
KEYS = [
    PoseKey(
        ...
        hammer_roll_head_pos(0.000, 0.840),
        IMPACT_QUAT,
    ...
    PoseKey(
        ...
        BASE_YAW,
        PELVIS_Z,
        merge_joints(STABLE_LEGS, LOW_ARMS, {"waist_pitch_joint": 0.17, "waist_yaw_joint": 0.02, "waist_roll_joint": 0.00}),
        hammer_roll_head_pos(0.000, 0.830),
        COMPRESS_QUAT,
    ...
    PoseKey(
        ...
        BASE_YAW,
        PELVIS_Z,
        merge_joints(STABLE_LEGS, LOW_ARMS, {"waist_pitch_joint": 0.14, "waist_yaw_joint": 0.01, "waist_roll_joint": 0.01}),
        hammer_roll_head_pos(0.020, 0.900),
        RELEASE_QUAT,
    ...
    PoseKey(
        ...
        BASE_YAW,
        PELVIS_Z,
        merge_joints(STABLE_LEGS, HIGH_ARMS, {"waist_pitch_joint": 0.10, "waist_yaw_joint": -0.02, "waist_roll_joint": 0.01}),
        hammer_roll_head_pos(0.050, 0.970),
        LIFT_LOW_QUAT,
    ...
    PoseKey(
        ...
        BASE_YAW,
        PELVIS_Z,
        merge_joints(STABLE_LEGS, HIGH_ARMS, {"waist_pitch_joint": 0.08, "waist_yaw_joint": -0.03, "waist_roll_joint": 0.01}),
        hammer_roll_head_pos(0.080, 1.035),
        LIFT_MID_QUAT,
    ...
    PoseKey(
        ...
        BASE_YAW,
        PELVIS_Z,
        merge_joints(STABLE_LEGS, HIGH_ARMS, {"waist_pitch_joint": 0.07, "waist_yaw_joint": -0.03, "waist_roll_joint": 0.01}),
        hammer_roll_head_pos(0.100, 1.075),
        LIFT_TOP_QUAT,
        np.array([0.96, 0.96, 1.08]),
    ),
    PoseKey(
        ...
        BASE_YAW,
        PELVIS_Z,
        merge_joints(STABLE_LEGS, HIGH_ARMS, {"waist_pitch_joint": 0.08, "waist_yaw_joint": -0.02, "waist_roll_joint": 0.00}),
        hammer_roll_head_pos(0.085, 1.060),
        LIFT_TOP_QUAT,
    ...
    PoseKey(
        ...
        BASE_YAW,
        PELVIS_Z,
        merge_joints(STABLE_LEGS, HIGH_ARMS, {"waist_pitch_joint": 0.10, "waist_yaw_joint": -0.01, "waist_roll_joint": 0.00}),
        hammer_roll_head_pos(0.060, 0.990),
        AIM_HIGH_QUAT,
    ...
    PoseKey(
        ...
        BASE_YAW,
        PELVIS_Z,
        merge_joints(STABLE_LEGS, LOW_ARMS, {"waist_pitch_joint": 0.12, "waist_yaw_joint": 0.00, "waist_roll_joint": 0.00}),
        hammer_roll_head_pos(0.025, 0.910),
        AIM_LOW_QUAT,
    ...
    PoseKey(
        ...
        BASE_YAW,
        PELVIS_Z,
        merge_joints(STABLE_LEGS, LOW_ARMS, {"waist_pitch_joint": 0.15, "waist_yaw_joint": 0.01, "waist_roll_joint": 0.00}),
        hammer_roll_head_pos(0.005, 0.860),
        STRIKE_PRE_QUAT,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", type=Path, default=DEFAULT_RENDER_DIR / "v3_g1_mochitsuki_multi_angle_demo.mp4")
